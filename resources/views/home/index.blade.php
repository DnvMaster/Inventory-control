        ...
        <div class="col-lg-5">
          <div class="lonyo-hero-thumb" data-aos="fade-left" data-aos-duration="700">
            ...
            <div class="lonyo-hero-shape">
              <img src="{{ asset('frontend/images/shape/hero-shape1.svg') }}" alt="">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-xl-4 col-lg-6 col-md-6">
          <div class="lonyo-service-wrap light-bg" data-aos="fade-up" data-aos-duration="500">
            <div class="lonyo-service-title">
              ...
              <img src="{{ asset('frontend/images/v1/feature1.svg') }}" alt="">
            </div>
        ...
        <div class="col-xl-4 col-lg-6 col-md-6">
          <div class="lonyo-service-wrap light-bg" data-aos="fade-up" data-aos-duration="700">
            <div class="lonyo-service-title">
              ...
              <img src="{{ asset('frontend/images/v1/feature2.svg') }}" alt="">
            </div>
            <div class="lonyo-service-data">
        ...
        <div class="col-xl-4 col-lg-6 col-md-6">
          <div class="lonyo-service-wrap light-bg" data-aos="fade-up" data-aos-duration="900">
            <div class="lonyo-service-title">
              ...
              <img src="{{ asset('frontend/images/v1/feature3.svg') }}" alt="">
            </div>
            <div class="lonyo-service-data">
        ...
        <div class="col-xl-4 col-lg-6 col-md-6">
          <div class="lonyo-service-wrap light-bg" data-aos="fade-up" data-aos-duration="500">
            <div class="lonyo-service-title">
              ...
              <img src="{{ asset('frontend/images/v1/feature4.svg') }}" alt="">
            </div>
            <div class="lonyo-service-data">
        ...
        <div class="col-xl-4 col-lg-6 col-md-6">
          <div class="lonyo-service-wrap light-bg" data-aos="fade-up" data-aos-duration="700">
            <div class="lonyo-service-title">
              ...
              <img src="{{ asset('frontend/images/v1/feature5.svg') }}" alt="">
            </div>
            <div class="lonyo-service-data">
        ...
        <div class="col-xl-4 col-lg-6 col-md-6">
          <div class="lonyo-service-wrap light-bg" data-aos="fade-up" data-aos-duration="900">
            <div class="lonyo-service-title">
              ...
              <img src="{{ asset('frontend/images/v1/feature6.svg') }}" alt="">
            </div>
            <div class="lonyo-service-data">
      ...
      <div class="row">
        <div class="col-lg-5">
          <div class="lonyo-content-thumb" data-aos="fade-up" data-aos-duration="700">
            <img src="{{ asset('frontend/images/v1/content-thumb.png') }}" alt="">
          </div>
        </div>
        <div class="col-lg-7 d-flex align-items-center">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-5 order-lg-2">
          <div class="lonyo-content-thumb" data-aos="fade-up" data-aos-duration="700">
            <img src="{{ asset('frontend/images/v1/content-thumb2.png') }}" alt="">
          </div>
        </div>
        <div class="col-lg-7 d-flex align-items-center">
          <div class="lonyo-default-content pr-50" data-aos="fade-right" data-aos-duration="700">
            ...
            <div class="mt-50">
              <ul class="tabs">
                <li class="active-tab">
                  <img src="{{ asset('frontend/images/v1/tv.svg') }}" alt="">
                  <h4>Unified Dashboard</h4>
                </li>
                <li>
                  <img src="{{ asset('frontend/images/v1/alerm.svg') }}" alt="">
      ...
      <div class="row">
        <div class="col-lg-5">
          <div class="lonyo-video-thumb">
            <img src="{{ asset('frontend/images/v1/video-thumb.png') }}" alt="">
      ...
      <div class="row">
        <div class="col-xl-4 col-md-6">
          <div class="lonyo-process-wrap" data-aos="fade-up" data-aos-duration="500">
            <div class="lonyo-process-number">
              <img src="{{ asset('frontend/images/v1/n1.svg') }}" alt="">
            </div>
        ...
        <div class="col-xl-4 col-md-6">
          <div class="lonyo-process-wrap" data-aos="fade-up" data-aos-duration="700">
            <div class="lonyo-process-number">
              <img src="{{ asset('frontend/images/v1/n2.svg') }}" alt="">
            </div>
            <div class="lonyo-process-title">
        ...
        <div class="col-xl-4 col-md-6">
          <div class="lonyo-process-wrap" data-aos="fade-up" data-aos-duration="900">
            <div class="lonyo-process-number">
              <img src="{{ asset('frontend/images/v1/n3.svg') }}" alt="">
            </div>
            <div class="lonyo-process-title">
  ...
  <div class="lonyo-section-padding position-relative overflow-hidden">
    ...
    <div class="lonyo-testimonial-slider-init">
      <div class="lonyo-t-wrap wrap2 light-bg">
        ...
        <div class="lonyo-t-author">
          <div class="lonyo-t-author-thumb">
            <img src="{{ asset('frontend/images/v1/img7.png') }}" alt="">
          </div>
      ...
      <div class="lonyo-t-wrap wrap2 light-bg">
        ...
        <div class="lonyo-t-author">
          <div class="lonyo-t-author-thumb">
            <img src="{{ asset('frontend/images/v1/img2.png') }}" alt="">
          </div>
          <div class="lonyo-t-author-data">
            <p>Michael Chen</p>
      ...
      <div class="lonyo-t-wrap wrap2 light-bg">
        ...
        <div class="lonyo-t-author">
          <div class="lonyo-t-author-thumb">
            <img src="{{ asset('frontend/images/v1/img3.png') }}" alt="">
          </div>
          <div class="lonyo-t-author-data">
            <p>David Nguyen</p>
      ...
      <div class="lonyo-t-wrap wrap2 light-bg">
        ...
        <div class="lonyo-t-author">
          <div class="lonyo-t-author-thumb">
            <img src="{{ asset('frontend/images/v1/img5.png') }}" alt="">
          </div>
          <div class="lonyo-t-author-data">
            <p>Rachel Kim</p>
      ...
      <div class="lonyo-t-wrap wrap2 light-bg">
        ...
        <div class="lonyo-t-author">
          <div class="lonyo-t-author-thumb">
            <img src="{{ asset('frontend/images/v1/img6.png') }}" alt="">
          </div>
          <div class="lonyo-t-author-data">
            <p>Aisha Hassan</p>
