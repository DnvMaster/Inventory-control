                        ...
                        <ul id="side-menu">
                            ...
                            <li>
                                ...
                                <div class="collapse" id="sidebarDashboards">
                                    <ul class="nav-second-level">
                                        <li><a href="index.html" class="tp-link">Главная</a></li>
                                        <li><a href="ecommerce.html" class="tp-link">Комменрция</a></li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li>
                                ...
                                <div class="collapse" id="sidebarAuth">
                                    <ul class="nav-second-level">
                                        <li>
                                            <a href="auth-login.html" class="tp-link">Вход</a>
                                        </li>
                                        <li>
                                            <a href="auth-register.html" class="tp-link">Регистрация</a>
                                        </li>
                                        <li>
                                            <a href="auth-recoverpw.html" class="tp-link">Восстановление пароля</a>
                                        </li>
                                        <li>
                                            <a href="auth-lock-screen.html" class="tp-link">Блокировка</a>
                                        </li>
                                        <li>
                                            <a href="auth-confirm-mail.html" class="tp-link">Отправка почты</a>
                                        </li>
                                        <li>
                                            <a href="email-verification.html" class="tp-link">Проверка почты</a>
                                        </li>
                                        <li>
                                            <a href="auth-logout.html" class="tp-link">Выход</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li>
                                ...
                                <div class="collapse" id="sidebarError">
                                    <ul class="nav-second-level">
                                        <li>
                                            <a href="error-404.html" class="tp-link">Ошибка 404</a>
                                        </li>
                                        <li>
                                            <a href="error-500.html" class="tp-link">Ошибка 500</a>
                                        </li>
                                        <li>
                                            <a href="error-503.html" class="tp-link"> Ошибка 503</a>
                                        </li>
                                        <li>
                                            <a href="error-429.html" class="tp-link">Ошибка 429</a>
                                        </li>
                                        <li>
                                            <a href="offline-page.html" class="tp-link">Статическая страница</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
